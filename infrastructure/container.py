...
from application.services.alert import AlertService, OutlierAlertChecker, ThresholdAlertChecker
from application.services.metric import MetricService, LengthMetricCalculator
...
class Container(containers.DeclarativeContainer):
    ...
    wiring_config = containers.WiringConfiguration(modules=chain(
        Events.modules(),
        Handlers.modules()
    ))
    ...
    metric_service = providers.Factory(
        MetricService,
